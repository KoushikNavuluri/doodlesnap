...
export default function DoodleStudio() {
  ...
  const handleGenerateDoodle = async () => {
    ...
    // Since this component is now protected by ProtectedRoute, user will always be authenticated
    setIsLoading(true);
    setDoodledImage(null);
  ...
  const renderEditorState = () => (
    <div className="w-full max-w-6xl grid grid-cols-1 md:grid-cols-2 gap-8 items-start animate-in fade-in-50">
        <Card>
            <CardHeader>
